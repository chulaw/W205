...
def dumpInningsDetails(inningsNum, teamBat, teamBowl, playerLinksBat, playersBat, dismissalsBat, runsBat, minutesBat, ballsBat, foursBat, sixesBat, totalBat, totalDetails, fow, playerLinksBowl, detailsBowl):
    ...
    for j in range(len(playerLinksBowl)):
        ...
        if odiId == 2725 and inningsNum == 1 and bugFixed == 0: # handle odi #2725 sami faridi case
            ...
            bugFixed = 1
        if odiId == 3482 and inningsNum == 1 and bugFixed == 0:
            detailsBowl.insert(20, '8')
            bugFixed = 1
        if odiId > 1747 and odiId not in (1749, 1765, 1773, 1781, 1782, 1791, 1805, 1809, 1811, 1817, 1833, 1913, 1915, 1920, 2074, 2101, 2110, 2251, 2259, 2260, 2261, 2262, 2270, 2271, 2272, 2273, 2282, 2290, 2302, 2339, 2340, 2343, 2344, 2350, 2353, 2355, 2356, 2374, 2375, 2376, 2378, 2390, 2391, 2396, 2397, 2399, 2400, 2401, 2406, 2407, 2444, 2445, 2446, 2448, 2450, 2451, 2453, 2454, 2455, 2456, 2465, 2467, 2476, 2477, 2480, 2481, 2483, 2484, 2489, 2491, 2492, 2494, 2495, 2496, 2498, 2499, 2500, 2502, 2503, 2504, 2505, 2507, 2508, 2509, 2511, 2512, 2516, 2518, 2528, 2529, 2530, 2585, 2586, 2596, 2599, 2600, 2601, 2602, 2603, 2604, 2609, 2610, 2634, 2636, 2638, 2640, 2641, 2690, 2693, 2694, 2695, 2722, 2727, 2728, 2729, 2731, 2737, 2738, 2739, 2740, 2741, 2743, 2744, 2746, 2747, 2749, 2751, 2752, 2753, 2763, 2764, 2765, 2766, 2767, 2768, 2769, 2770, 2771, 2772, 2776, 2784, 2786, 2787, 2788, 2789, 2792, 2797, 2799, 2801, 2805, 2807, 2809, 2812, 2814, 2830, 2831, 2835, 2836, 2837, 2838, 2842, 2843, 2844, 2856, 2857, 2858, 2859, 2860, 2861, 2875, 2876, 2877, 2878, 2879, 2880, 2881, 2908, 2909, 2910, 2911, 2912, 2922, 2926, 2928, 2949, 2951, 2953, 2956, 2957, 2958, 2959, 2977, 2978, 2992, 2997, 3005, 3006, 3007, 3008, 3009, 3010, 3012, 3013, 3014, 3015, 3016, 3017, 3019, 3020, 3021, 3022, 3023, 3024, 3027, 3028, 3029, 3033, 3034, 3035, 3036, 3041, 3042, 3048, 3049, 3050, 3051, 3052, 3053, 3055, 3092, 3096, 3099, 3157, 3158, 3164, 3166, 3171, 3172, 3173, 3174, 3185, 3192, 3193, 3196, 3197, 3230, 3232, 3234, 3242, 3245, 3270, 3271, 3282, 3287, 3306, 3307, 3335, 3336, 3337, 3338, 3339, 3341, 3342, 3344, 3345, 3356, 3357, 3358, 3359, 3379, 3381, 3384, 3386, 3405, 3407, 3410, 3411, 3413, 3417, 3418, 3423, 3426, 3429, 3459, 3460, 3464, 3466, 3468, 3472, 3487, 3488, 3489, 3491, 3492, 3503, 3504, 3505, 3506, 3527, 3528, 3529, 3541, 3542, 3556, 3558, 3560, 3562, 3572, 3573, 3575, 3576, 3581): # cricinfo scorecards display 0s, 4s and 6s scored off bowler
...
for x in range(startODI, len(odisInfo)):
    ...
    if ',' in  scoreTree.xpath('(//div[@class="bold space-top-bottom-10"]/span/text())')[0]: ballsPerOver = 6
